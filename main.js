...
exampleCoin.addBlock(new Block(1, "10/07/2024", { amount: 4 }));
exampleCoin.addBlock(new Block(2, "12/07/2024", { amount: 10 }));

console.log('Is blockchain valid? ' + exampleCoin.isChainValid());
